...
export class AnnotationsRepository {
  ...
  static async update(
    ...
    if (updates.pos0 && typeof updates.pos0 === 'object')
      (data as any).pos0 = JSON.stringify(updates.pos0);
    if (updates.pos1 && typeof updates.pos1 === 'object')
      (data as any).pos1 = JSON.stringify(updates.pos1);
    ...
    if (data.pos0 !== undefined)
      mapped.pos0 =
        typeof (data as any).pos0 === 'object'
          ...
          : ((data as any).pos0 ?? null);
    if (data.pos1 !== undefined)
      mapped.pos1 =
        typeof (data as any).pos1 === 'object'
          ? JSON.stringify((data as any).pos1)
          : ((data as any).pos1 ?? null);
    if (data.datetime_updated !== undefined)
      mapped.datetime_updated = (data as any).datetimeUpdated ?? null;
